...
(function() {
    $('<a href="javascript:void()" style="position:fixed;z-index:999;top:24px;left:300px">Print</a>').appendTo('body').click(function(){
